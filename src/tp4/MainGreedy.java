...
public class MainGreedy {
	...
	public static void main(String[] args) {
        ...
        Greedy  = new Greedy(entrada4);
        System.out.println("-Entrada 4------- ");
        System.out.println("Grupo de trabajo : "+entrada4.fuerzadeTrabajoTotal()+" " + entrada4);
        System.out.println("Resultado: Greedy");
        Greedy.CrearSolucion();
        System.out.println("");
        
        Greedy  = new Greedy(entrada5);
